#Mencetak informasi dengan mengubah stringnya(s)
...
print("Lima karakter terakhir adalah '%s''" % s[-5:]) #5th-from-las to end
...
print("""MEMBUAT YANG SEHARUSNYA!!!
""")
#Membuat yang seharusnya
